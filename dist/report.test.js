...
var fs_1 = require("fs");
var fileExists = __importStar(require("./utils/file-exists"));
var logger_1 = require("./logger");
var report_1 = require("./report");
describe('report.ts', function () {
    var logger = new logger_1.Logger();
    var htmlTemplate = '<h1>Hello World<h1>';
    var readdirMock = jest.spyOn(fs_1.promises, 'readdir');
    var mkdirMock = jest.spyOn(fs_1.promises, 'mkdir');
    var readFileMock = jest.spyOn(fs_1.promises, 'readFile');
    var writeFileMock = jest.spyOn(fs_1.promises, 'writeFile');
    var cwdMock = jest
    ...
    it('should get the screenshots and create the html report', function () { return __awaiter(void 0, void 0, void 0, function () {
        var handlebarsCompileMock;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(fileExists, 'fileExists').mockResolvedValue(true);
                    handlebarsCompileMock = jest
                        .spyOn(handlebars_1.default, 'compile')
                        .mockImplementationOnce(function () { return function () { return '<h1>Hello World Compiled</h1>'; }; });
                    readFileMock
                        .mockResolvedValueOnce('{}')
                        .mockResolvedValueOnce(htmlTemplate);
                    mkdirMock.mockResolvedValue(undefined);
                    readdirMock.mockResolvedValue([]);
                    return [4 /*yield*/, (0, report_1.generateReport)(logger, 'ios')];
                case 1:
                    _a.sent();
    ...
    it('should not generate the report if there is no baseline screenshots directory', function () { return __awaiter(void 0, void 0, void 0, function () {
        var handlebarsCompileMock;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
