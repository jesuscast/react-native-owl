...
var startWebSocketServer = function (logger) { return __awaiter(void 0, void 0, void 0, function () {
    var wss;
    return __generator(this, function (_a) {
        wss = new ws_1.default.Server({ port: constants_1.WEBSOCKET_PORT });
...
var createWebSocketClient = function (logger, onMessage) { return __awaiter(void 0, void 0, void 0, function () {
    var wsClient;
    return __generator(this, function (_a) {
        wsClient = new ws_1.default("ws://localhost:" + constants_1.WEBSOCKET_PORT);
        return [2 /*return*/, new Promise(function (resolve) {
                wsClient.on('open', function () { return resolve(wsClient); });
