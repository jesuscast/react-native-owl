...
var fileExistsHelpers = __importStar(require("./utils/file-exists"));
var SCREENSHOT_FILENAME = 'screen';
describe('screenshot.ts', function () {
    var commandMock = jest.spyOn(execa_1.default, 'command');
    var mkdirMock = jest.spyOn(fs_1.promises, 'mkdir').mockImplementation();
    var writeFileMock = jest.spyOn(fs_1.promises, 'writeFile').mockImplementation();
    var cwdMock = jest
        .spyOn(process, 'cwd')
    ...
    describe('Baseline', function () {
        ...
        describe('iOS', function () {
            ...
            it('should take a screenshot', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, screenshot_1.takeScreenshot)(SCREENSHOT_FILENAME)];
                        case 1:
                            _a.sent();
    ...
    describe('Latest', function () {
        ...
        describe('iOS', function () {
                    ...
                    switch (_a.label) {
                        case 0:
                            jest
                                ...
                                .mockResolvedValueOnce(true);
                            return [4 /*yield*/, (0, screenshot_1.takeScreenshot)(SCREENSHOT_FILENAME)];
                        case 1:
                            _a.sent();
                            expect(commandMock).toHaveBeenCalledWith('xcrun simctl io iPhone\\ Simulator screenshot screen.png', {
            ...
            it('should take a screenshot - baseline does not exist', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, screenshot_1.takeScreenshot)(SCREENSHOT_FILENAME)];
                        case 1:
